...
public class InsectPlayer extends Player{
    ...
    public void moveTo(Tile tile) {
        ...
        if(answer.equalsIgnoreCase("Y")){
            printWrapper("The insect is paralyzed and cannot move", ArrowDirection.RIGHT, Indent.UNINDENT);
            return;
        }
    ...
    public void cut(Tile tile){
        ...
        if(answer.equalsIgnoreCase("N")){
            printWrapper("The insect cannot cut", ArrowDirection.RIGHT, Indent.UNINDENT);
            return;
        }
